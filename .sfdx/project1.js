...
input.addEventListener("input",function(eve){
    ...
    if(newUsers.length==0){
      ...
      msgCard.textContent='No Users Found';
      msgCard.style.font="16px";
      msgCard.style.color="Red";
      msgCard.style.backgroundColor="white";
      msgCard.style.padding="2px 2px";
      console.log(msgCard);
      document.querySelector(".cards").appendChild(msgCard);
    }
    else{
       showUsers(newUsers);
    }
